...
--
-- Host: localhost    Database: quarto
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'quarto'
--
...
BEGIN
update `game_status` set `status`='not active' ,`p_turn`=null ,`current_piece`=null ,`result`=null,`win_combination`='not set';
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `place_piece`( X1 TINYINT(1), Y1 TINYINT(1),  pieceid INT)
BEGIN
UPDATE board   
